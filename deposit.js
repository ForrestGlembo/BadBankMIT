...
return (
  ...
  <Card
    ...
    body={show ? (  
            ...
            <input type="input" className="form-control" id="deposit" placeholder="" value={deposit} onChange={e => setDeposit(e.currentTarget.value)}/>
            </div>
            <br/>
            <button type="submit" disabled={disable} className="btn btn-light" onClick={validateDeposit}>Deposit</button>
            </>
          ):(
            <>
            <h5>Success</h5>
